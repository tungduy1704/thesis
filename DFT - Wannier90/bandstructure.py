...
def plot_bandstructure_along_kx(filename="wannier90_hr.dat", nk=200):
    ...
    for i, kx in enumerate(tqdm(kx_vals, desc="Bandstructure calculating ~~~~")):
